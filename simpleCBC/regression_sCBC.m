function  [b, residuals, Chi, df, EXITFLAG, H] = regression_sCBC(S_t0, S_t5, S_t10, S_t20, x_meas_t,...
    d_meas_t0, d_meas_t5, d_meas_t10, d_meas_t20,d_meas_t40,...
    rubp_MIDs, f6p_MIDs, g6p_MIDs, fbp_MIDs, g1p_MIDs, adpg_MIDs, model,sta_n,d_sta,suc_n,d_suc)
%% INPUT:
...
%% reduce to used MIDs
d_meas_t0 = d_meas_t0{:,[rubp_MIDs, f6p_MIDs, g6p_MIDs, fbp_MIDs, g1p_MIDs, adpg_MIDs]};
d_meas_t5 = d_meas_t5{:,[rubp_MIDs, f6p_MIDs, g6p_MIDs, fbp_MIDs, g1p_MIDs, adpg_MIDs]};
d_meas_t10 = d_meas_t10{:,[rubp_MIDs, f6p_MIDs, g6p_MIDs, fbp_MIDs, g1p_MIDs, adpg_MIDs]};
d_meas_t20 = d_meas_t20{:,[rubp_MIDs, f6p_MIDs, g6p_MIDs, fbp_MIDs, g1p_MIDs, adpg_MIDs]};
d_meas_t40 = d_meas_t40{:,[rubp_MIDs, f6p_MIDs, g6p_MIDs, fbp_MIDs, g1p_MIDs, adpg_MIDs]};

d_tp = x_meas_t.LabelingTime_sec_(2:end)-x_meas_t.LabelingTime_sec_(1:end-1);

x_meas_t=x_meas_t{:,[rubp_MIDs, f6p_MIDs, g6p_MIDs, fbp_MIDs, g1p_MIDs, adpg_MIDs]};

num_MIDs=length([[rubp_MIDs, f6p_MIDs, g6p_MIDs, fbp_MIDs, g1p_MIDs, adpg_MIDs]]);

% extract stoichiometric matrix from network
N=model.S;

% create lb and ub vectors combining vectors of individual parts 
% (e.g. v, eps, sta)
...
LB(end+1)=LB_e; % difference estimated and measured starch synthesis rate
